...
VALUES ('Fallout 76', 'El juego se desarrolla en Appalachia, conformado por el antiguo estado estadounidense de Virginia Occidental en el año 2102, 25 años después de la Gran Guerra y antes de cualquier juego anterior de Fallout. Involucra al Refugio 76, uno de los diecisiete refugios de control conocidos, diseñado sin un experimento social. El personaje jugador abandona el Refugio 76 luego de celebrarse el "Día de la Recuperación" y tras haber sido enviado a una misión por la Supervisora, una mujer que abandonó el refugio antes que el resto de los moradores.', 'uploads/image-1688412460320-441822332.jpg');
